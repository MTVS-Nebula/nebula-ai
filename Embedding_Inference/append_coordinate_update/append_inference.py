...
def Coordinate():
    ...
    return x_coord, y_coord, z_coord, reqIds, keywords1, keywords2, keywords3, keywords4


@app.route('/')
def root():
    # update database
    x_coord, y_coord, z_coord, reqIds, keywords1, keywords2, keywords3, keywords4 = Coordinate()
    try:
